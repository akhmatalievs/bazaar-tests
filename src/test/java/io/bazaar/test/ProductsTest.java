...
public class ProductsTest
{
    ...
    public void run() {
        ...
        {
            WebElement element = driver.findElement(By.linkText("Peers"));
        ...
        {
            WebElement element = driver.findElement(By.cssSelector("#ug-menu-warroom > .sidebar-menu-item"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element).perform();
        }
        {
        ...
        {
            WebElement element = driver.findElement(By.linkText("Environments"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element).perform();
        }
        {
        ...
        driver.findElement(By.cssSelector("#ug-menu-bazaar .sidebar-menu-item__caption")).click();
        {
            WebElement element = driver.findElement(By.cssSelector("#ug-menu-bazaar .sidebar-menu-item__caption"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element).perform();
        }
        {
        ...
        assertThat(driver.findElement(By.linkText("pgAdmin")).getText(), is("pgAdmin"));
